...
var DateTimeShortcuts = {
    ...
    addClock: function(inp) {
        ...
        quickElement('img', clock_link, '', 'src', DateTimeShortcuts.admin_media_prefix + 'media/admin/img/admin/icon_clock.gif', 'alt', gettext('Clock'));
    ...
    addCalendar: function(inp) {
        ...
        quickElement('img', cal_link, '', 'src', DateTimeShortcuts.admin_media_prefix + 'media/admin/img/admin/icon_calendar.gif', 'alt', gettext('Calendar'));
        shortcuts_span.appendChild(document.createTextNode('\240'));
