...
from freevle.organizer.homework_views import get_course_view, update_homework_view, update_homework_extend
...
#        name='homework-create'),
    ...
    url(r'update-homework/get-more-forms/$',
        update_homework_extend, {}, name='organizer-update-homework-extend'),
